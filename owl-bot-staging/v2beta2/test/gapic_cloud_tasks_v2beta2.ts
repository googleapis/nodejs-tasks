...
describe('v2beta2.CloudTasksClient', () => {
    ...
    describe('leaseTasks', () => {
        it('invokes leaseTasks without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('LeaseTasksRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('acknowledgeTask', () => {
        it('invokes acknowledgeTask without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('AcknowledgeTaskRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('renewLease', () => {
        it('invokes renewLease without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('RenewLeaseRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.tasks.v2beta2.Task()
    ...
    describe('cancelLease', () => {
        it('invokes cancelLease without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CancelLeaseRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.tasks.v2beta2.Task()
