...
describe('v2beta3.CloudTasksClient', () => {
    ...
    describe('listQueues', () => {
        it('invokes listQueues without error', done => {
            ...
            const expectedResponse = {};
            // Mock Grpc layer
            client._innerApiCalls.listQueues = (actualRequest: {}, options: {}, callback: Callback) => {
    ...
    describe('listQueuesStream', () => {
        it('invokes listQueuesStream without error', done => {
            ...
            const stream = client.listQueuesStream(request, {}).on('data', (response: {}) =>{
                assert.deepStrictEqual(response, expectedResponse);
                done();
    ...
    describe('listTasks', () => {
        it('invokes listTasks without error', done => {
            ...
            const expectedResponse = {};
            // Mock Grpc layer
            client._innerApiCalls.listTasks = (actualRequest: {}, options: {}, callback: Callback) => {
                assert.deepStrictEqual(actualRequest, request);
                callback(null, expectedResponse);
            };
    ...
    describe('listTasksStream', () => {
        it('invokes listTasksStream without error', done => {
            ...
            const stream = client.listTasksStream(request, {}).on('data', (response: {}) =>{
                assert.deepStrictEqual(response, expectedResponse);
                done();
            }).on('error', (err: FakeError) => {
                done(err);
