...
describe('v2beta2.CloudTasksClient', () => {
    ...
    describe('getQueue', () => {
        ...
        it('invokes getQueue with error', async () => {
            ...
            assert.rejects(async () => { await client.getQueue(request); }, expectedError);
            assert((client.innerApiCalls.getQueue as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('createQueue', () => {
        ...
        it('invokes createQueue with error', async () => {
            ...
            assert.rejects(async () => { await client.createQueue(request); }, expectedError);
            assert((client.innerApiCalls.createQueue as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('updateQueue', () => {
        ...
        it('invokes updateQueue with error', async () => {
            ...
            assert.rejects(async () => { await client.updateQueue(request); }, expectedError);
            assert((client.innerApiCalls.updateQueue as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('deleteQueue', () => {
        ...
        it('invokes deleteQueue with error', async () => {
            ...
            assert.rejects(async () => { await client.deleteQueue(request); }, expectedError);
            assert((client.innerApiCalls.deleteQueue as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('purgeQueue', () => {
        ...
        it('invokes purgeQueue with error', async () => {
            ...
            assert.rejects(async () => { await client.purgeQueue(request); }, expectedError);
            assert((client.innerApiCalls.purgeQueue as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('pauseQueue', () => {
        ...
        it('invokes pauseQueue with error', async () => {
            ...
            assert.rejects(async () => { await client.pauseQueue(request); }, expectedError);
            assert((client.innerApiCalls.pauseQueue as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('resumeQueue', () => {
        ...
        it('invokes resumeQueue with error', async () => {
            ...
            assert.rejects(async () => { await client.resumeQueue(request); }, expectedError);
            assert((client.innerApiCalls.resumeQueue as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('getTask', () => {
        ...
        it('invokes getTask with error', async () => {
            ...
            assert.rejects(async () => { await client.getTask(request); }, expectedError);
            assert((client.innerApiCalls.getTask as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('createTask', () => {
        ...
        it('invokes createTask with error', async () => {
            ...
            assert.rejects(async () => { await client.createTask(request); }, expectedError);
            assert((client.innerApiCalls.createTask as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('deleteTask', () => {
        ...
        it('invokes deleteTask with error', async () => {
            ...
            assert.rejects(async () => { await client.deleteTask(request); }, expectedError);
            assert((client.innerApiCalls.deleteTask as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('leaseTasks', () => {
        it('invokes leaseTasks without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.leaseTasks as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes leaseTasks with error', async () => {
            ...
            assert.rejects(async () => { await client.leaseTasks(request); }, expectedError);
            assert((client.innerApiCalls.leaseTasks as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('acknowledgeTask', () => {
        it('invokes acknowledgeTask without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.acknowledgeTask as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes acknowledgeTask with error', async () => {
            ...
            assert.rejects(async () => { await client.acknowledgeTask(request); }, expectedError);
            assert((client.innerApiCalls.acknowledgeTask as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('renewLease', () => {
        it('invokes renewLease without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.renewLease as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes renewLease with error', async () => {
            ...
            assert.rejects(async () => { await client.renewLease(request); }, expectedError);
            assert((client.innerApiCalls.renewLease as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('cancelLease', () => {
        it('invokes cancelLease without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.cancelLease as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes cancelLease with error', async () => {
            ...
            assert.rejects(async () => { await client.cancelLease(request); }, expectedError);
            assert((client.innerApiCalls.cancelLease as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('runTask', () => {
        ...
        it('invokes runTask with error', async () => {
            ...
            assert.rejects(async () => { await client.runTask(request); }, expectedError);
            assert((client.innerApiCalls.runTask as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('listQueues', () => {
        ...
        it('invokes listQueues with error', async () => {
            ...
            assert.rejects(async () => { await client.listQueues(request); }, expectedError);
            assert((client.innerApiCalls.listQueues as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listTasks', () => {
        ...
        it('invokes listTasks with error', async () => {
            ...
            assert.rejects(async () => { await client.listTasks(request); }, expectedError);
            assert((client.innerApiCalls.listTasks as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
